...
The author uses the following tools, grouped by purpose:
...
The author uses Hermes Agent to back itself up, retaining only the newest snapshots to conserve cloud storage space.
